...
firebase.auth().onAuthStateChanged((firebaseUser) => {
    if (firebaseUser) {
        ...
        firebase.auth().currentUser.getIdTokenResult().then((idTokenResult) => {
            ...
            if (!idTokenResult.claims.idnumber || !currentUser.displayName) {
                document.querySelector('#error-content').innerHTML = "Please finish setting up your account <a href='account.html'>here</a>";
                //hide content
